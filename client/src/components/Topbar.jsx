...
export const Topbar = ({ onMenuClick, onLogout, user, quickActions = [] }) => (
  <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/95 backdrop-blur">
    <div className="flex flex-wrap items-center gap-3 px-5 py-3 sm:px-8">
      ...
      <div className="hidden min-w-[200px] flex-1 items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-slate-400 sm:flex lg:max-w-[320px]">
        <Search size={14} />
