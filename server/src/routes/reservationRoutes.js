...
router.post('/', requireRoles(ROLES.MEMBER, ROLES.LIBRARIAN, ROLES.ADMIN), postReservation);
router.patch('/:id/cancel', requireRoles(ROLES.MEMBER, ROLES.LIBRARIAN, ROLES.ADMIN), postCancelReservation);
